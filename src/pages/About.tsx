      ...
      <div className="h-[calc(90vh-5rem)] m-2 rounded-4xl relative">
        ...
        <div className="relative z-10 h-full flex items-end justify-center">
          <div className="text-center text-white">
            <h2 className="font-extrabold text-3xl md:text-5xl lg:text-6xl leading-tight mb-6 text-white">Shopertyy</h2>
      ...
      <div className="m-2">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-20 grid gap-8 md:grid-cols-3">
            <div className="rounded-3xl bg-white p-8 shadow-md transition hover:shadow-lg">
