...
const DEFAULT_GLOW_COLOR = '0, 0, 0'; // Pure black
const MOBILE_BREAKPOINT = 768;

// Updated cardData with all imported images
const cardData: BentoCardProps[] = [
    {
        imageSrc: p1,
        title: 'The Omaxe State',
        description: 'Compact units ranging from 50 to 330 square feet with prices starting from 75 lakhs onwards',
        label: 'Premium'
    },
    {
        imageSrc: p2,
        title: 'Omaxe Chowk',
        description: 'Spacious units ranging from 480 to 1340 square feet with premium commercial spaces',
        label: 'Luxury'
    },
    {
        imageSrc: p3,
        title: 'Elan Imperial',
        description: 'Large units from 600 to 3000 square feet with exclusive business location',
        label: 'Elite'
    },
    {
        imageSrc: p4,
        title: 'M3M Route 65',
        description: 'Premium commercial spaces with strategic location and modern infrastructure',
        label: 'Business'
    },
    {
        imageSrc: p1,
        title: 'M3M Atrium 57',
        description: 'Modern commercial development with flexible unit options and premium amenities',
        label: 'Commercial'
    },
    {
        imageSrc: p2,
        title: 'M3M Paragon',
        description: 'Enterprise-grade commercial spaces with advanced security and connectivity',
        label: 'Enterprise'
    }
];
