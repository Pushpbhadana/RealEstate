  ...
  const features = [
    {
      ...
      title: "Mission",
      description: "We empower individuals and businesses with knowledge, resources, and support to make informed real estate decisions and achieve property goals confidently.",
    },
    {
      icon: <Target className="w-7 h-7" />,
      title: "Vision",
      description: "Shopertyy aims to redefine Gurugram's real estate, offering trust, expertise, and tailored solutions for individual's and businesses property needs.",
    },
    {
      icon: <TrendingUp className="w-7 h-7" />,
      title: "Core Values",
      description: "Our commitment to transparency, honesty, and trust underpins every interaction, nurturing enduring relationships with clients, partners, and stakeholders.",
    },
    
  ];

  return (
    <section className="py-10 md:py-10 m-2">
